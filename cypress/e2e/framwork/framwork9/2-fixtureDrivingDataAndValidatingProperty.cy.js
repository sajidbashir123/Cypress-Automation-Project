...
describe("Fixtures work in driving data", () => {
  ...
  it("test", function () {
    ...
    cy.wait(2000);
    cy.get(":nth-child(4) > .ng-pristine").should(
      "have.value",
      this.dataaa.name
    );
    ...
    /* Enabled and Disabled is not the property its a behavior which is used to verify
         it is enable/disable/visible/not visible from the code base */
